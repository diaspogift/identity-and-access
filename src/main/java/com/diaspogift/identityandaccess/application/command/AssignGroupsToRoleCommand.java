...
public class AssignGroupsToRoleCommand {

    private String tenantId;
    private List<String> groupNames;
    private String roleName;

    public AssignGroupsToRoleCommand(String tenantId, List<String> groupNames, String roleName) {
        super();
    ...
    public AssignGroupsToRoleCommand(String tenantId, String roleName, Collection<GroupRepresentation> groups) {
